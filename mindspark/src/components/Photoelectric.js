...
export default function Photoelectric() {
    ...
    var electrons = [];
    for (var i = 1; i <= 45; i++) {
        electrons.push(<div className="electrons my-3 mx-3" id={i}></div>);
    }


    return (
        <div className='container my-3'>
            <h1 className="text-center">Photoelectric Effect</h1>
            <div className="row my-3 photorow">
                <div className="col-4 photocol">
                    <h4 className="text-center">Einstiens Photoelectric Equation</h4>
                    ...
                    <div className="mb-3">
                        ...
                        <input type="number" className="form-control" id="freqinpt" value={freq} onChange={e => setfreq(e.target.value)} />
                    </div>
                    <button className="btn btn-success" onClick={calKE}>Submit</button>
                    <br />
                ...
                <div className="col-8 photocol">
                    <div className="rays">
                        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" className="bi bi-brightness-high" viewBox="0 0 16 16">
